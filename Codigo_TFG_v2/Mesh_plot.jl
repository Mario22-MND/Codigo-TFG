...
# Iteramos a traves de las aristas para poner los identificadores de los dofs
    ...
    if quad_meshes == false
        if b_edges[1] != 0
            ...
            for b_cond in b_conditions
                if ((b_edges[1] == Mesh_object.Boundary_cond.DIRICHLET) || (b_edges[1] == Mesh_object.Boundary_cond.NEUMAN) || (b_edges[1] == Mesh_object.Boundary_cond.CAUCHY) )
        ...
        if b_edges[2] != 0
            ...
            for b_cond in b_conditions
                if ((b_edges[2] == Mesh_object.Boundary_cond.DIRICHLET) || (b_edges[2] == Mesh_object.Boundary_cond.NEUMAN) || (b_edges[2] == Mesh_object.Boundary_cond.CAUCHY) )
                    if b_cond.type == Mesh_object.Boundary_cond.DIRICHLET
                        plot!(x, y, line=:solid, linecolor = :red, fillalpha = 0, linewidth=3)
                    elseif b_cond.type == Mesh_object.Boundary_cond.NEUMAN
                        plot!(x, y, line=:solid, linecolor = :black, fillalpha = 0, linewidth=3)
        ...
        if b_edges[3] != 0
            ...
            for b_cond in b_conditions
                if ((b_edges[3] == Mesh_object.Boundary_cond.DIRICHLET) || (b_edges[3] == Mesh_object.Boundary_cond.NEUMAN) || (b_edges[3] == Mesh_object.Boundary_cond.CAUCHY) )
                    if b_cond.type == Mesh_object.Boundary_cond.DIRICHLET
                        plot!(x, y, line=:solid, linecolor = :red, fillalpha = 0, linewidth=3)
                    elseif b_cond.type == Mesh_object.Boundary_cond.NEUMAN
                        plot!(x, y, line=:solid, linecolor = :black, fillalpha = 0, linewidth=3)
        ...
        if b_edges[4] != 0
            ...
            for b_cond in b_conditions
                if ((b_edges[4] == Mesh_object.Boundary_cond.DIRICHLET) || (b_edges[4] == Mesh_object.Boundary_cond.NEUMAN) || (b_edges[4] == Mesh_object.Boundary_cond.CAUCHY) )
                    if b_cond.type == Mesh_object.Boundary_cond.DIRICHLET
                        plot!(x, y, line=:solid, linecolor = :red, fillalpha = 0, linewidth=3)
                    elseif b_cond.type == Mesh_object.Boundary_cond.NEUMAN
                        plot!(x, y, line=:solid, linecolor = :black, fillalpha = 0, linewidth=3)
...
if quad_meshes == false 
    if order == 1 
        if length(b_conditions) == 1
            savefig("Mesh_images\\triangular_mesh_order_1_boundary_1.png")
        elseif length(b_conditions) == 2
            savefig("Mesh_images\\triangular_mesh_order_1_boundary_2.png")
        elseif length(b_conditions) == 3
            savefig("Mesh_images\\triangular_mesh_order_1_boundary_3.png")
        end
    elseif order == 2
        if length(b_conditions) == 1
            savefig("Mesh_images\\triangular_mesh_order_2_boundary_1.png")
        elseif length(b_conditions) == 2
            savefig("Mesh_images\\triangular_mesh_order_2_boundary_2.png")
        elseif length(b_conditions) == 3
            savefig("Mesh_images\\triangular_mesh_order_2_boundary_3.png")
        end
    elseif order == 3
        if length(b_conditions) == 1
            savefig("Mesh_images\\triangular_mesh_order_3_boundary_1.png")
        elseif length(b_conditions) == 2
            savefig("Mesh_images\\triangular_mesh_order_3_boundary_2.png")
        elseif length(b_conditions) == 3
            savefig("Mesh_images\\triangular_mesh_order_3_boundary_3.png")
        end
    end
else
    if order == 1 
        if length(b_conditions) == 1
            savefig("Mesh_images\\quad_mesh_order_1_boundary_1.png")
        elseif length(b_conditions) == 2
            savefig("Mesh_images\\quad_mesh_order_1_boundary_2.png")
        elseif length(b_conditions) == 3
            savefig("Mesh_images\\quad_mesh_order_1_boundary_3.png")
        end
    elseif order == 2
        if length(b_conditions) == 1
            savefig("Mesh_images\\quad_mesh_order_2_boundary_1.png")
        elseif length(b_conditions) == 2
            savefig("Mesh_images\\quad_mesh_order_2_boundary_2.png")
        elseif length(b_conditions) == 3
            savefig("Mesh_images\\quad_mesh_order_2_boundary_3.png")
        end
    end
end